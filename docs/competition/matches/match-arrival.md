...
!!! note
    Whilst this is aimed at documenting the competitor-facing process, some volunteer steps are included. For specifics, see [match scoring roles](./match-scoring.md).
...
When let into staging by the Head Shepherd, competitors will be instructed which corner they will start in, and told to stand at the corresponding part of the _in_ staging desk.

## 2. Competitors assemble in staging

Once in staging, competitors should stay at the _in_ staging desk unless instructed to move.

At the _in_ staging desk, teams will:
