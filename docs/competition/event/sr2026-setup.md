...
```mermaid
gantt
    title SR2026 Setup (Thursday)
    dateFormat HH:mm
    axisFormat %H:%M

    section Team A (3)
    Lay test arena flooring :testFlooring, 09:00, 1h
    Lay main arena flooring :mainFlooring, 10:30, 1h
    Lunch :lunchA, 12:30, 1h
    Mount and setup arena screens :setupCornerScreens, 13:30, 2h

    section Team B (4)
    Assemble test arena walls :testWalls, after testFlooring, 1h
    Assemble main arena walls :mainWalls, after mainFlooring, 1h
...
gantt
    ...
    Lunch :lunchA, 12:30, 45m
    Training :trainingA, after lunchA, 2.5h
    ...
    Lunch :lunchB, 12:30, 45m
    Training :trainingB, after lunchB, 2.5h
    ...
    Lunch :lunchC, 12:30, 45m
    Training :trainingC, after lunchC, 2.5h

    section Team D (4)
    Make swag bags :swagBags, 09:00, 3.5h
    Lunch :lunchD, 12:30, 45m
    Training :trainingD, after lunchD, 2.5h

    section Team E (2)
    Add hi-vis jacket labels :jacketLabels, 09:00, 1h
    Lunch :lunchE, 12:30, 45m
    Training :trainingE, after lunchE, 2.5h
